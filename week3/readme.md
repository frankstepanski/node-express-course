...
Then we register the middleware with the use() method (right after the require statement):
...
As with any other middleware function, you need to tell your Express app **to use** this feature.
  ...
  - Find a **cute** cat image and create an **images** folder inside the public folder. Putting the cat image in the images folder.
